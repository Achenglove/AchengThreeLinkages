package com.ccr.threelinkkagelibrary.widget.base;
...
import com.ccr.threelinkkagelibrary.listener.OnItemSelectedListener;
import com.ccr.threelinkkagelibrary.view.TimePickerView.TextSize;
import com.ccr.threelinkkagelibrary.view.TimePickerView.Type;
...
public class WheelTime {
    ...
    private float mTextSize = TextSize.DEFAULT;
    ...
    public void setMaxmonthPicker(int year, int month, int day, int h, int m, int maxMoth) {
        if (maxMoth == 0) {
            maxMoth = 12;
        }
        // 添加大小月月份并将其转换为list,方便之后的判断
        ...
        // 月
        wv_month = (WheelView) view.findViewById(R.id.month);
        wv_month.setAdapter(new NumericWheelAdapter(1, maxMoth));
        wv_month.setLabel(context.getString(R.string.pickerview_month));
        wv_month.setCurrentItem(month);
